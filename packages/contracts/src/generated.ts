...
export interface paths {
    ...
    "/api/v1/installments/{installmentId}/streams": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            streamId: string;
                            /** @enum {string} */
                            idSource: "installment.imdb" | "installment.tmdb" | "title.imdb" | "title.tmdb";
                            candidates: {
                                id: string;
                                /** @enum {string} */
                                kind: "torrent" | "direct";
                                ...
                                /** @enum {string} */
                                quality: "2160p" | "1440p" | "1080p" | "720p" | "480p" | "360p" | "cam" | "unknown";
                                height: number | null;
                                seeders: number | null;
                ...
                400: {
                    ...
                    content: {
                        "application/json": {
                            /** @enum {string} */
                            code: "not_found" | "not_permitted" | "no_identifier" | "unsupported_kind" | "source_unavailable" | "source_not_configured";
                            message: string;
                        };
                    };
                };
