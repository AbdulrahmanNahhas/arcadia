...
export const auth = betterAuth({
  ...
  trustedOrigins: [
    ...
    // See the matching comment in app.ts's CORS trustedOrigins — a packaged Tauri app serves
    // from a platform-dependent fixed origin, and Linux uses the tauri:// custom scheme.
    "tauri://localhost",
