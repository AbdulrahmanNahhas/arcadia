...
export function RelationshipEditor({
  ...
  return (
    <div className="space-y-3">
      {relations.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-6 border border-dashed border-border rounded-lg text-center bg-muted/20">
          <LinkIcon className="size-8 text-muted-foreground/40 mb-2" />
          ...
          <div className="space-y-2">
            {relations.map((relation, index) => (
              <div
                ...
                className="flex flex-col lg:flex-row items-stretch lg:items-center gap-2 p-2.5 bg-muted/30 rounded-md border border-border/60 hover:border-border transition-colors"
              >
                {/* Target Work Dropdown */}
                <div className="flex min-w-[200px]">
                  <Select
                    value={relation.workId}
                    onValueChange={(val) => update(index, { workId: val })}
                  >
                ...
                <Button
                  ...
                  className="size-8 text-muted-foreground hover:text-destructive shrink-0 self-end lg:self-auto"
                >
