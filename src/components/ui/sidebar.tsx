      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>يعرض الشريط الجانبي على الهاتف.</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">إظهار أو إخفاء الشريط الجانبي</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="إظهار أو إخفاء الشريط الجانبي"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="إظهار أو إخفاء الشريط الجانبي"
      className={cn(
